...
class App
{
	...
	public static function run($dir)
	{
		...
		if (!file_exists($dir . '/fulltext'))
			mkdir($dir . '/fulltext', 0777, true);
		if (!file_exists($dir . '/files_html'))
		...
		if (!file_exists($dir . '/uploads/cover'))
			mkdir($dir . '/uploads/cover', 0777, true);
		if (!file_exists($dir . '/uploads/featured'))
